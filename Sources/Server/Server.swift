...
struct Server {
    static func main() async throws {
        ...
        // handlers to the app.
        try handler.registerHandlers(on: transport, serverURL: Servers.Server2.url())
        ...
        openapi.get { $0.redirect(to: "/openapi.html") }
        openapi.get("editor") { $0.redirect(to: "/swagger_editor.html") }
        openapi.get("editor", "next") { $0.redirect(to: "/swagger_editor_next.html")}
        app.get { $0.redirect(to: "/resume/wangzhizhou.pdf") }
